                        ...
                        <tbody>
                            <?php foreach ($this->tutorials as $item) { ?>
                                <tr id="tu-<?php echo $item['id']; ?>" class="<?php echo ($item['id'] % 2 == 0) ? 'even' : 'odd'; ?>">
                                    ...
                                    <td data-label="分类"><?php echo $item['category_name']; ?></td>
                                    <td data-label="管理"><a href="<?php echo $this->baseUrl(); ?>/tutorial/view/id/<?php echo $item['id']; ?>/" target="_blank">查看</a> | <a href="<?php echo $this->baseUrl(); ?>/tutorial/edit/id/<?php echo $item['id']; ?>/" target="_blank">编辑</a> | <a href="javascript:tutorial_delete(<?php echo $item['id']; ?>);">删除</a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
