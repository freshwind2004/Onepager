...
class Captcha
{
    ...
    public function create($len = 4, $push = true)
    {
        ...
        $bgColor = imagecolorallocate($im, mt_rand(0, 150), mt_rand(0, 150), mt_rand(0, 150));
        ...
        for ($i = 0; $i < strlen($text); $i ++) {
            ...
            // 字符颜色和透明度
            $col = imagecolorallocatealpha($im, mt_rand(150, 255), mt_rand(150, 255), mt_rand(150, 255), mt_rand(10, 50));
        ...
        for ($i = 1; $i <= $lineNum; $i ++) {
            ...
            $col = imagecolorallocatealpha($im, mt_rand(0, 150), mt_rand(0, 150), mt_rand(0, 150), mt_rand(40, 50));
